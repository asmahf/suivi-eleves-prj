...
<body>
    <section>
        <div class="container">
            ...
            <form class="form" method="POST">
                ...
                <p> Si vous n'êtes pas enseignant <a href="index.php">Retourner</a></p>
            </form>
            <div id="error"></div>
        </div>
    </section>
    ...
    if (isset($_SESSION['user'])) {
        if ($_SESSION['user']->type_utilis === "enseignant") {
            header("location:http://localhost/suivi-eleves-prj/enseignant/index.php", true);
            die("");
        }
    }
    ...
    if (isset($_POST['login'])) {
        ...
        if ($login->rowCount() === 1) {
            ...
            if ($user->type_utilis === "enseignant") {
                header("location:./enseignant/index.php", true);
            } else {
