...
<body>
        ...
        <div class="container">
            ...
            <form class="form" method="POST">
                <div id="logo" class="text-center">
                    <img src="./pic/users/family.png" alt="parent">
                </div>
                ...
                <p> Si vous n'avez pas de compte <a href="./registre.php">S'inscrire</a></p>
                <p> Si vous n'êtes pas un parent <a href="index.php">Retourner</a></p>
            </form>
            <div id="error"></div>
        </div>
    </section>
    ...
    if (isset($_SESSION['user'])) {
        if ($_SESSION['user']->type_utilis === "parent") {
            header("location:http://localhost/suivi-eleves-prj/parent/index.php", true);
            die("");
        }
    }
    ?>
    ...
    if (isset($_POST['login'])) {
        ...
        if ($login->rowCount() === 1) {
            ...
            if ($user->type_utilis === "parent") {
                header("location:./parent/index.php", true);
            } else {
